<script lang="ts">
  // Props
  export let onPortfolioClick: () => void;
...
<div class="quick-actions">
  ...
  <div class="actions-grid">
    <button class="action-btn primary" on:click={onPortfolioClick}>
    ...
    <button class="action-btn success" on:click={onProjectClick}>
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
      </svg>
    ...
    <button class="action-btn warning" on:click={onCategoryClick}>
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <button class="action-btn info" on:click={onSectionClick}>
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
